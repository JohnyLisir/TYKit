...
-(UIButton *)cancelButton{
    if (!_cancelButton) {
        ...
        [_cancelButton setBackgroundImage:[UIColor whiteColor].image forState:0];
        [_cancelButton setBackgroundImage:[UIColor colorWithWhite:0.95f alpha:1.0f].image forState:1<<0];
...
-(UIButton *)customButton{
    ...
    [button setBackgroundImage:[UIColor whiteColor].image forState:0];
    [button setBackgroundImage:[UIColor colorWithWhite:0.95f alpha:1.0f].image forState:1<<0];
    return button;
}
