...
-(void)reloadCarousel;
//点击的回调
@property (nonatomic,copy) void (^ iGCarouselSelectedBlock)(NSInteger index , IGCarouselObject *carouselObject);
